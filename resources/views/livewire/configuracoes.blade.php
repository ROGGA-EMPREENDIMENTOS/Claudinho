...
<div x-data="{ aberto: false, salvo: false }" x-on:claudinho-abrir-configuracoes.window="aberto = true"
    ...
    <div style="display: none" x-show="aberto" class="fixed inset-0 z-50 flex items-center justify-center p-4"
        ...
        <div
            class="relative w-full max-w-lg overflow-hidden bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-900 dark:border-gray-800">
            ...
            <form wire:submit="salvar" class="flex flex-col gap-4 p-4">
